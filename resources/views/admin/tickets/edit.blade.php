<x-app-layout>
    ...
    <div class="mx-auto max-w-2xl">
        <div class="dash-card">
            <div class="flex justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-neutral-400">Update ticket details, status, and priority.</p>
                </div>
                <div>
                    <label class="mb-2 block text-sm font-medium text-white">Priority</label>
                    ...
                    <span
                        ...
                        @if ($priority === 'low') bg-green-900
                        @elseif ($priority === 'medium') bg-yellow-900
                        @elseif ($priority === 'high') bg-red-900
                        @elseif ($priority === 'urgent') bg-purple-900
        @else bg-gray-900 @endif">
            ...
            <form method="POST" action="{{ route('admin.tickets.update', $ticket) }}" class="mt-6 space-y-5">
                @csrf
                @method('PUT')
                ...
                <div>
                    <label for="status" class="mb-2 block text-sm font-medium text-white">Status</label>
