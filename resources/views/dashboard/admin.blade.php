    ...
    <div class="mx-auto max-w-6xl space-y-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <div class="dash-card">
                ...
                <p class="mt-2 text-3xl font-semibold text-white">{{ \App\Models\User::count() }}</p>
            </div>
        </div>
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            ...
            <div class="dash-card">
                ...
                <ul class="mt-4 space-y-2">
                    <li>
                        <span class="flex items-center gap-3 rounded-md px-3 py-2 text-sm text-neutral-500">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 00-2 2v3a2 2 0 110 4v3a2 2 0 002 2h14a2 2 0 002-2v-3a2 2 0 110-4V7a2 2 0 00-2-2H5z" />
                            </svg>
                            Manage All Tickets
                            <span class="ml-auto text-xs text-neutral-600">Soon</span>
                        </span>
                    </li>
                    <li>
                        <span class="flex items-center gap-3 rounded-md px-3 py-2 text-sm text-neutral-500">
