    ...
    <div class="mx-auto max-w-6xl space-y-6">
        ...
        <div class="grid gap-6 lg:grid-cols-3">
            <div class="dash-card lg:col-span-2">
                ...
                <div class="mt-6 flex flex-col items-center justify-center rounded-md border border-dashed border-neutral-800 py-12 text-center">
            ...
            <div class="dash-card">
                ...
                <ul class="mt-4 space-y-2">
                    <li>
                        <a href="{{ route('admin.tickets.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm text-neutral-400 hover:bg-neutral-800 hover:text-white">
                    ...
                    <li>
                        <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm text-neutral-400 hover:bg-neutral-800 hover:text-white">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="{{ route('profile.edit') }}" class="flex items-center gap-3 rounded-md px-3 py-2 text-sm text-neutral-400 transition hover:bg-neutral-800 hover:text-white">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
